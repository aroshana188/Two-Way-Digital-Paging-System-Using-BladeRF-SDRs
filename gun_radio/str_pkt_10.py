...
class str_pkt_10(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_repack_bits_bb_1_1 = blocks.repack_bits_bb(2, 1, "packet_len", False, gr.GR_MSB_FIRST)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\PC\\University\\Semester_3\\EN2130_Communication Design Project\\Project\\apple.txt', True, 0, 0)
        ...
        self.connect((self.blocks_repack_bits_bb_1, 0), (self.blocks_throttle2_0_0, 0))
        self.connect((self.blocks_repack_bits_bb_1_0, 0), (self.digital_crc32_bb_0_0, 0))
        self.connect((self.blocks_repack_bits_bb_1_1, 0), (self.blocks_uchar_to_float_0_0, 0))
        self.connect((self.blocks_repack_bits_bb_1_1, 0), (self.digital_correlate_access_code_xx_ts_0, 0))
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.blocks_unpack_k_bits_bb_0_0, 0))
        self.connect((self.blocks_throttle2_0_0, 0), (self.digital_constellation_modulator_0, 0))
        ...
        self.connect((self.digital_map_bb_0, 0), (self.blocks_repack_bits_bb_1_1, 0))
