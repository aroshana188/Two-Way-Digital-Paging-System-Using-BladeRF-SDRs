...
class Telelink(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Telelink")
        ...
        self._noise_volt_range = qtgui.Range(0, 1, 0.01, 0.001, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, "C:/Users/PC/Desktop/Output.txt", False)
