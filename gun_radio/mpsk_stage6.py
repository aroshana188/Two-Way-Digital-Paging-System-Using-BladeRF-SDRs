...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0_1, 0), (self.digital_constellation_modulator_0, 0))
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_0, 0), (self.blocks_unpack_k_bits_bb_0_1, 0))
