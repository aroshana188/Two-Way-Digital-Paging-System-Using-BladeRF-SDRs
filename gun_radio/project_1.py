...
import project_1_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class project_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "project_1")
        ...
        self.epy_block_0 = epy_block_0.MessageToByteArray()
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("12345"), 1000)
        ...
        self.msg_connect((self.digital_crc32_async_bb_1, 'out'), (self.pdu_pdu_to_tagged_stream_0, 'pdus'))
...
def main(top_block_cls=project_1, options=None):
