...
class gui_io(gr.basic_block):
    """
    GUI I/O block with PyQt5 chat window (bubble style)
    """
    def __init__(self, my_name="userA"):
        gr.basic_block.__init__(self, name="gui_io", in_sig=[], out_sig=[])
