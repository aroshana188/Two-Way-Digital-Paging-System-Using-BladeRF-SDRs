...
class CommunicationSystem(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "CommunicationSystem")
        ...
        self.soapy_bladerf_source_0_0.set_bandwidth(0, bw)
        self.soapy_bladerf_source_0_0.set_frequency(0, freq)
        self.soapy_bladerf_source_0_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_source_0_0.set_gain(0, min(max(10.0, -1.0), 60.0))
        ...
        self.epy_block_8 = epy_block_8.crc()
        self.epy_block_7 = epy_block_7.address_filter(my_addr=0x00)
        ...
        self.connect((self.soapy_bladerf_source_0_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
    ...
    def set_freq(self, freq):
        ...
        self.soapy_bladerf_source_0_0.set_frequency(0, self.freq)
    ...
    def set_bw(self, bw):
        ...
        self.soapy_bladerf_source_0_0.set_bandwidth(0, self.bw)
