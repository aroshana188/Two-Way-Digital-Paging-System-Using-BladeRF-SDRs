...
class attempt_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "attempt_4")
        ...
        self.pdu_tagged_stream_to_pdu_1_0 = pdu.tagged_stream_to_pdu(gr.types.byte_t, 'packet_len')
        ...
        self.digital_linear_equalizer_0 = digital.linear_equalizer(4, 2, variable_adaptive_algorithm_0, True, [ ], 'corr_est')
        ...
        self.digital_correlate_access_code_tag_xx_0 = digital.correlate_access_code_tag_bb("11100001010110101110100010010011", 1, 'packet_len')
        self.digital_constellation_soft_decoder_cf_0 = digital.constellation_soft_decoder_cf(qpsk, 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\PC\\University\\Semester_3\\EN2130_Communication Design Project\\Project\\apple.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\PC\\University\\Semester_3\\EN2130_Communication Design Project\\Project\\apple2.txt', False)
        ...
        self.msg_connect((self.digital_crc_check_0, 'ok'), (self.pdu_pdu_to_tagged_stream_1_0, 'pdus'))
        ...
        self.msg_connect((self.pdu_tagged_stream_to_pdu_1, 'pdus'), (self.digital_crc_append_0, 'in'))
        self.msg_connect((self.pdu_tagged_stream_to_pdu_1_0, 'pdus'), (self.blocks_message_debug_0, 'print'))
        self.msg_connect((self.pdu_tagged_stream_to_pdu_1_0, 'pdus'), (self.digital_crc_check_0, 'in'))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        self.connect((self.blocks_pack_k_bits_bb_0, 0), (self.digital_correlate_access_code_tag_xx_0, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.pdu_tagged_stream_to_pdu_1, 0))
        self.connect((self.blocks_tagged_stream_align_1, 0), (self.pdu_tagged_stream_to_pdu_1_0, 0))
        ...
        self.connect((self.digital_constellation_soft_decoder_cf_0, 0), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.digital_correlate_access_code_tag_xx_0, 0), (self.blocks_tagged_stream_align_1, 0))
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_1_0, 0), (self.blocks_file_sink_0, 0))
...
def main(top_block_cls=attempt_4, options=None):
